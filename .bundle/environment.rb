...
module Bundler
  LOCKED_BY    = '0.9.21'
  FINGERPRINT  = "f71197d0b1b7f081287b5ffc6901bbaba8a0b9fe"
  HOME         = '/Users/carlosbrando/.rvm/gems/ruby-1.8.7-p249/bundler'
  AUTOREQUIRES = {:default=>[["thor", false]]}
  SPECS        = [
        {:loaded_from=>"/Users/carlosbrando/.rvm/gems/ruby-1.8.7-p249/specifications/thor-0.13.4.gemspec", :load_paths=>["/Users/carlosbrando/.rvm/gems/ruby-1.8.7-p249/gems/thor-0.13.4/lib"], :name=>"thor"},
      ].map do |hash|
